...
architecture STRUCTURE of design_1_sample_generator_0_0_sample_generator_v1_0_M_AXIS is
  ...
  signal \afterResetCycleCounterR[7]_i_4_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \afterResetCycleCounterR[7]_i_3\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \m_axis_tdata[26]_INST_0\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \m_axis_tdata[27]_INST_0\ : label is "soft_lutpair22";
  ...
  attribute SOFT_HLUTNM of \m_axis_tdata[5]_INST_0\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of \packetCounter[7]_i_3\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of sampleGeneratorEnR_i_2 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of sampleGeneratorEnR_i_3 : label is "soft_lutpair4";
begin
...
\afterResetCycleCounterR[7]_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\afterResetCycleCounterR[7]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
...
\afterResetCycleCounterR[7]_i_4\: unisim.vcomponents.LUT6
    generic map(
...
entity design_1_sample_generator_0_0 is
  ...
  attribute x_core_info of design_1_sample_generator_0_0 : entity is "sample_generator_v1_0,Vivado 2018.3";
...
U0: entity work.design_1_sample_generator_0_0_sample_generator_v1_0
     port map (
      axi_en => axi_en,
      en => en,
      framesize(7 downto 0) => framesize(7 downto 0),
