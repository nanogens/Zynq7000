...
HD_PWD='D:/Github/Zynq7000/ZynqTraining/Session_09_II_Lab_01_CreatingBaseHWforExportToXilinx/axis-example/vivado/project_3/project_3.runs/design_1_axi_smc_1_synth_1'
cd "$HD_PWD"
