...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net s_axis_aresetn_1 [get_bd_ports s_axis_aresetn] [get_bd_pins sample_generator_0/m_axis_aresetn] [get_bd_pins sample_generator_0/s_axis_aresetn]
