...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("OutputData_TDATA", 32, hls_out, 1, "axis", "out_data", 1),
	Port_Property("OutputData_TVALID", 1, hls_out, 1, "axis", "out_vld", 1),
	Port_Property("OutputData_TREADY", 1, hls_in, 1, "axis", "out_acc", 1),
