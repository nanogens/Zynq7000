# 1 "C/axi_stream_counter_range.cpp"
# 1 "C/axi_stream_counter_range.cpp" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 152 "<built-in>" 3
# 1 "<command line>" 1
...
# 9 "<command line>" 2
# 1 "<built-in>" 2
# 1 "C/axi_stream_counter_range.cpp" 2


int axi_stream_counter_range(int count_range, int * counter_output)
{
_ssdm_op_SpecInterface(count_range, "axis", 1, 1, "both", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
# 4 "C/axi_stream_counter_range.cpp"

_ssdm_op_SpecInterface(counter_output, "axis", 1, 1, "both", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
# 4 "C/axi_stream_counter_range.cpp"
