...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         ...
         "c.axi_stream_counter_range.autotvin_counter_output.dat"
         "c.axi_stream_counter_range.autotvout_counter_output.dat"
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.axi_stream_counter_range.autotvout_counter_output.dat"
