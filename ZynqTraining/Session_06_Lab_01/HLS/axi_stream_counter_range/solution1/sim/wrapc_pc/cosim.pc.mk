# ==============================================================
# File generated on Mon Jan 21 17:59:02 -0500 2019
...
$(ObjDir)/axi_stream_counter_range_testbench.cpp_pre.cpp.tb.o : axi_stream_counter_range_testbench.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling axi_stream_counter_range_testbench.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/axi_stream_counter_range.cpp_pre.cpp.tb.o : axi_stream_counter_range.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling axi_stream_counter_range.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
